"""my code is a car quiz that consists of 11 questions and people will enjoy it."""

# Created by Gurshaan Singh Bansal
# Date 27 / 02 / 2023
# Demonstrate asking the user a question
# Provide multiple choice awnsers, get the user's awnser, check if its correct


# User input is what the user puts in the text box.
# Correct answer is the variable that activates when the user has
# entered a input that is part of the correct answer list.
# Incorrect answer is if the user enters one of the options
# that are listed and then tells them that is is the wrong aswer.
...
# Elif is used when you want to check for a different condition
# but the initial if statement is false.
# Else is when the code tries if and elif statements
# and if it is not true it will redirect to else statement
